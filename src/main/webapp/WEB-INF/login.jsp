...
<head>
    ...
    <STYLE>
        ...
        * {
        ...
        .v_logo {
            background: url("${pageContext.request.contextPath}/static/images/vcode.png") no-repeat;
            padding: 10px 10px;
            position: absolute;
            top: 12px;
            left: 40px;
        ...
        <div>
            ...
            <P style="position: relative;">
                ...
                <img onclick="javascript:loadimage();" title="换一张试试" name="randImage" id="randImage"
                     src="${pageContext.request.contextPath}/blog/codesImg.do" width="90" height="30" border="1"
                     align="absmiddle">
            </P>
        </div>
