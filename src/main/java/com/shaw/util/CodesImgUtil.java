...
public class CodesImgUtil {
	...
	public static void getCodesImg(HttpServletResponse response, HttpServletRequest request) throws Exception {
		...
		for (int i = 0; i < 4; i++) {
			Character rand = CODES[(random.nextInt(CODES.length))];
			sRand.append(rand);
