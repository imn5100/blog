...
<form action="/login.html" method="post" id="login_form">
	<DIV style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 200px; text-align: center;">
		...
		<P style="padding: 30px 0px 10px; position: relative;">
			...
			<input id="userName" name="userName" class="ipt" type="text" placeholder="请输入用户名" maxlength="20"  required/>
	    </P>
		<P style="position: relative;">
			<SPAN class="p_logo"></SPAN>
			<input id="password" name="password" class="ipt"  type="password" placeholder="请输入密码"  maxlength="20" value="" required/>
	  	</P>
	  	</div>
		<DIV style="height: 50px; line-height: 50px; margin-top: 30px; border-top-color: rgb(231, 231, 231); border-top-width: 1px; border-top-style: solid;">
	        ...
	        <SPAN style="float: right;">
	              <input type="submit" style="background: rgb(0, 142, 173); padding: 8px 12px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;" value="登录"/>
	         </SPAN>
	         </P>
	    </DIV>
	</DIV>
